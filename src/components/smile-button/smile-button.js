...
import './smile-button.css'

export default class SmileButton extends  Component {
    render() {
        return (
                ...
                <div className="rating">
                    <form className="rating-form">
                        ...
                        <label htmlFor="super-happy">
                            <input type="radio" name="rating" className="super-happy" id="super-happy"
                                   value="super-happy"/>
                        ...
                        <label htmlFor="happy">
                            <input type="radio" name="rating" className="happy" id="happy" value="happy" checked/>
